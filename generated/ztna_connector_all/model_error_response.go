...
func NewErrorResponse(error_ ErrorObject) *ErrorResponse {
	this := ErrorResponse{}
	this.Error = error_
	return &this
}
...
func (o *ErrorResponse) GetError() ErrorObject {
	if o == nil {
		var ret ErrorObject
		return ret
	}
...
func (o *ErrorResponse) GetErrorOk() (*ErrorObject, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *ErrorResponse) SetError(v ErrorObject) {
	o.Error = v
}
