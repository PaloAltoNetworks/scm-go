...
// ErrorDetailCauseInfo Detailed information about an error cause including code, message, and contextual details
type ErrorDetailCauseInfo struct {
	// Error code identifying the type of error
	Code *string `json:"code,omitempty"`
	// Additional error details as string or structured object
