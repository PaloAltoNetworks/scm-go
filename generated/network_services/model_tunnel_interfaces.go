...
func (o *TunnelInterfaces) GetNetflowProfile() string {
...
// and a boolean to check if the value has been set.
func (o *TunnelInterfaces) GetNetflowProfileOk() (*string, bool) {
	if o == nil || IsNil(o.NetflowProfile) {
		return nil, false
	}
...
func (o *TunnelInterfaces) HasNetflowProfile() bool {
	if o != nil && !IsNil(o.NetflowProfile) {
		return true
	}
...
func (o *TunnelInterfaces) SetNetflowProfile(v string) {
	o.NetflowProfile = &v
}
