...
/*
Testing utilities for config_operations API
Shared utilities for testing config_operations API services
*/
package config_operations
...
func SetupConfigOperationsTestClient(t *testing.T) *config_operations.APIClient {
	...
	return setup.GetConfigOperationsAPIClient(setupClient)
}

// printAPIError prints formatted API error response from error object's body
func printAPIError(err *config_operations.GenericOpenAPIError) {
	if err == nil {
		return
	}
...
func handleAPIError(err error) {
	...
	var apiErr *config_operations.GenericOpenAPIError
