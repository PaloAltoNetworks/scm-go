...
// APIClient manages communication with the Config Operations API v2.0.0
...
type APIClient struct {
	...
	ConfigVersionsAPI *ConfigVersionsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ConfigVersionsAPI = (*ConfigVersionsAPIService)(&c.common)
