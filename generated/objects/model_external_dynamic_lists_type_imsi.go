...
type _ExternalDynamicListsTypeImsi ExternalDynamicListsTypeImsi

// NewExternalDynamicListsTypeImsi instantiates a new ExternalDynamicListsTypeImsi object
...
// NewExternalDynamicListsTypeImsiWithDefaults instantiates a new ExternalDynamicListsTypeImsi object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewExternalDynamicListsTypeImsiWithDefaults() *ExternalDynamicListsTypeImsi {
	this := ExternalDynamicListsTypeImsi{}
	var certificateProfile string = "None"
	this.CertificateProfile = &certificateProfile
	var url string = "http://"
...
func (o *ExternalDynamicListsTypeImsi) HasAuth() bool {
	if o != nil && !IsNil(o.Auth) {
		return true
	}
...
func (o *ExternalDynamicListsTypeImsi) GetCertificateProfile() string {
...
// and a boolean to check if the value has been set.
func (o *ExternalDynamicListsTypeImsi) GetCertificateProfileOk() (*string, bool) {
	if o == nil || IsNil(o.CertificateProfile) {
		return nil, false
	}
...
func (o *ExternalDynamicListsTypeImsi) HasCertificateProfile() bool {
	if o != nil && !IsNil(o.CertificateProfile) {
		return true
	}
...
func (o *ExternalDynamicListsTypeImsi) SetCertificateProfile(v string) {
	o.CertificateProfile = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *ExternalDynamicListsTypeImsi) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *ExternalDynamicListsTypeImsi) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *ExternalDynamicListsTypeImsi) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *ExternalDynamicListsTypeImsi) SetDescription(v string) {
	o.Description = &v
}

// GetExceptionList returns the ExceptionList field value if set, zero value otherwise.
func (o *ExternalDynamicListsTypeImsi) GetExceptionList() []string {
...
// and a boolean to check if the value has been set.
func (o *ExternalDynamicListsTypeImsi) GetExceptionListOk() ([]string, bool) {
	if o == nil || IsNil(o.ExceptionList) {
		return nil, false
	}
...
func (o *ExternalDynamicListsTypeImsi) HasExceptionList() bool {
	if o != nil && !IsNil(o.ExceptionList) {
		return true
	}
...
func (o *ExternalDynamicListsTypeImsi) SetExceptionList(v []string) {
	o.ExceptionList = v
}
...
func (o *ExternalDynamicListsTypeImsi) GetUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ExternalDynamicListsTypeImsi) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *ExternalDynamicListsTypeImsi) SetUrl(v string) {
	o.Url = v
}

func (o ExternalDynamicListsTypeImsi) MarshalJSON() ([]byte, error) {
...
func (o ExternalDynamicListsTypeImsi) ToMap() (map[string]interface{}, error) {
...
func (o *ExternalDynamicListsTypeImsi) UnmarshalJSON(data []byte) (err error) {
	...
	varExternalDynamicListsTypeImsi := _ExternalDynamicListsTypeImsi{}

	err = json.Unmarshal(data, &varExternalDynamicListsTypeImsi)

	if err != nil {
		return err
	}

	*o = ExternalDynamicListsTypeImsi(varExternalDynamicListsTypeImsi)
...
type NullableExternalDynamicListsTypeImsi struct {
	value *ExternalDynamicListsTypeImsi
	isSet bool
}

func (v NullableExternalDynamicListsTypeImsi) Get() *ExternalDynamicListsTypeImsi {
	return v.value
}

func (v *NullableExternalDynamicListsTypeImsi) Set(val *ExternalDynamicListsTypeImsi) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalDynamicListsTypeImsi) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalDynamicListsTypeImsi) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalDynamicListsTypeImsi(val *ExternalDynamicListsTypeImsi) *NullableExternalDynamicListsTypeImsi {
	return &NullableExternalDynamicListsTypeImsi{value: val, isSet: true}
}

func (v NullableExternalDynamicListsTypeImsi) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalDynamicListsTypeImsi) UnmarshalJSON(src []byte) error {
	v.isSet = true
