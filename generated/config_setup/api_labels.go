...
// FetchLabels retrieves a single Labels object by name.
//
...
//
// Returns:
//   - *Labels: The matching object if found, nil otherwise
//   - error: Any error that occurred during the fetch operation
//
// Example:
//
//	obj, err := api.FetchLabels(ctx, "my-object", &folder, nil, nil)
//	if err != nil {
//	    return err
//	}
//	if obj != nil {
...
//	}
func (a *LabelsAPIService) FetchLabels(ctx context.Context, name string, folder *string, snippet *string, device *string) (*Labels, error) {
	req := a.ListLabels(ctx).Name(name).Limit(5000)
