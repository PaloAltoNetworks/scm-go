...
/*
Testing utilities for identity_services API
Shared utilities for testing identity_services API services
*/
package identity_services
...
func SetupIdentitySvcTestClient(t *testing.T) *identity_services.APIClient {
...
func printAPIError(err *identity_services.GenericOpenAPIError) {
	if err == nil {
		return
	}
...
func handleAPIError(err error) {
	...
	var apiErr *identity_services.GenericOpenAPIError
