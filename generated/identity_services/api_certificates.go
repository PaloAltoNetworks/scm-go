...
// FetchCertificates retrieves a single CertificatesGet object by name.
//
...
//
// Returns:
//   - *CertificatesGet: The matching object if found, nil otherwise
//   - error: Any error that occurred during the fetch operation
//
// Example:
//
//	obj, err := api.FetchCertificates(ctx, "my-object", &folder, nil, nil)
//	if err != nil {
//	    return err
//	}
//	if obj != nil {
...
//	}
func (a *CertificatesAPIService) FetchCertificates(ctx context.Context, name string, folder *string, snippet *string, device *string) (*CertificatesGet, error) {
	req := a.ListCertificates(ctx).Name(name).Limit(5000)
