...
/*
Testing utilities for device_settings API
Shared utilities for testing device_settings API services
*/
package device_settings
...
func SetupDeviceSettingsTestClient(t *testing.T) *device_settings.APIClient {
	...
	return setup.GetDeviceSettingsAPIClient(setupClient)
}

// printAPIError prints formatted API error response from error object's body
func printAPIError(err *device_settings.GenericOpenAPIError) {
	if err == nil {
		return
	}
...
func handleAPIError(err error) {
	...
	var apiErr *device_settings.GenericOpenAPIError
