...
func (o *ErrorDetailCauseInfo) GetDetails() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ErrorDetailCauseInfo) GetDetailsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Details) {
...
func (o *ErrorDetailCauseInfo) SetDetails(v map[string]interface{}) {
	o.Details = v
}
