...
// SetupSecuritySvcTestClient No specific test utilities for this package.
func SetupSecuritySvcTestClient(t *testing.T) *security_services.APIClient {
...
func printAPIError(err *security_services.GenericOpenAPIError) {
	if err == nil {
		return
	}
...
func handleAPIError(err error) {
	...
	var apiErr *security_services.GenericOpenAPIError
