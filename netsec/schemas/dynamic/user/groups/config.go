...
Param Tags ([]string): Tags for dynamic user group object List must contain at most 64 elements. Individual elements in this list are subject to additional validation. String length must not exceed 127 characters.
*/
type Config struct {
