...
Param Request (qFWAgJG.Config): the Request param.
...
type CreateInput struct {
	...
	Request *qFWAgJG.Config `json:"request,omitempty"`
...
// Method: post
// URI: /tags
func (c *Client) Create(ctx context.Context, input CreateInput) (qFWAgJG.Config, error) {
	// Variables.
	var err error
...
// Method: put
// URI: /tags/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (qFWAgJG.Config, error) {
	// Variables.
	var err error
	var ans qFWAgJG.Config
	path := "/tags/{id}"
...
// Method: delete
// URI: /tags/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (qFWAgJG.Config, error) {
	// Variables.
	var err error
	var ans qFWAgJG.Config
	path := "/tags/{id}"
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]qFWAgJG.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]qFWAgJG.Config)
		total := int(*ans.Total)
	...
	listing := make([]qFWAgJG.Config, 0, len(items))
	for key := range items {
