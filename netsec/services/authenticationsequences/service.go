package authenticationsequences
...
Param Request (zLXjrfn.Config): the Request param.
...
type CreateInput struct {
	...
	Request *zLXjrfn.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /authentication-sequences
func (c *Client) Create(ctx context.Context, input CreateInput) (zLXjrfn.Config, error) {
	// Variables.
	var err error
	var ans zLXjrfn.Config
	path := "/authentication-sequences"
...
//
// Method: get
// URI: /authentication-sequences/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (zLXjrfn.Config, error) {
	// Variables.
	var err error
	var ans zLXjrfn.Config
	path := "/authentication-sequences/{id}"
...
// Method: put
// URI: /authentication-sequences/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (zLXjrfn.Config, error) {
	// Variables.
	var err error
	var ans zLXjrfn.Config
	path := "/authentication-sequences/{id}"
...
// Method: delete
// URI: /authentication-sequences/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (zLXjrfn.Config, error) {
	// Variables.
	var err error
	var ans zLXjrfn.Config
	path := "/authentication-sequences/{id}"
...
Param Data ([]zLXjrfn.Config): the Data param.
...
type ListOutput struct {
	Data   []zLXjrfn.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]zLXjrfn.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]zLXjrfn.Config)
		total := int(*ans.Total)
	...
	listing := make([]zLXjrfn.Config, 0, len(items))
	for key := range items {
