...
Param Request (qhDZEMT.Config): the Request param.
...
type CreateInput struct {
	...
	Request  *qhDZEMT.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /app-override-rules
func (c *Client) Create(ctx context.Context, input CreateInput) (qhDZEMT.Config, error) {
	// Variables.
	var err error
	var ans qhDZEMT.Config
	path := "/app-override-rules"
...
//
// Method: get
// URI: /app-override-rules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (qhDZEMT.Config, error) {
	// Variables.
	var err error
	var ans qhDZEMT.Config
	path := "/app-override-rules/{id}"
...
// Method: put
// URI: /app-override-rules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (qhDZEMT.Config, error) {
	// Variables.
	var err error
	var ans qhDZEMT.Config
	path := "/app-override-rules/{id}"
...
// Method: delete
// URI: /app-override-rules/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (qhDZEMT.Config, error) {
	// Variables.
	var err error
	var ans qhDZEMT.Config
	path := "/app-override-rules/{id}"
...
Param Data ([]qhDZEMT.Config): the Data param.
...
type ListOutput struct {
	Data   []qhDZEMT.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]qhDZEMT.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]qhDZEMT.Config)
		total := int(*ans.Total)
	...
	listing := make([]qhDZEMT.Config, 0, len(items))
	for key := range items {
...
//
// Method: post
// URI: /app-override-rules/{id}:move
func (c *Client) Move(ctx context.Context, input MoveInput) error {
	// Variables.
	var err error
	path := "/app-override-rules/{id}:move"
