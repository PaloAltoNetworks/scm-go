...
Param Request (zGfKFAQ.Config): the Request param.
...
type CreateInput struct {
	...
	Request *zGfKFAQ.Config `json:"request,omitempty"`
...
// Method: post
// URI: /hip-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (zGfKFAQ.Config, error) {
	// Variables.
	var err error
...
// Method: get
// URI: /hip-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (zGfKFAQ.Config, error) {
	// Variables.
	var err error
	var ans zGfKFAQ.Config
	path := "/hip-profiles/{id}"
...
// Method: put
// URI: /hip-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (zGfKFAQ.Config, error) {
	// Variables.
	var err error
	var ans zGfKFAQ.Config
	path := "/hip-profiles/{id}"
...
// Method: delete
// URI: /hip-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (zGfKFAQ.Config, error) {
	// Variables.
	var err error
	var ans zGfKFAQ.Config
	path := "/hip-profiles/{id}"
...
Param Data ([]zGfKFAQ.Config): the Data param.
...
type ListOutput struct {
	Data   []zGfKFAQ.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]zGfKFAQ.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]zGfKFAQ.Config)
		total := int(*ans.Total)
	...
	listing := make([]zGfKFAQ.Config, 0, len(items))
	for key := range items {
