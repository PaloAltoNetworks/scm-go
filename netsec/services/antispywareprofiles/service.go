...
Param Request (lrzxLXR.Config): the Request param.
...
type CreateInput struct {
	...
	Request *lrzxLXR.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /anti-spyware-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (lrzxLXR.Config, error) {
	// Variables.
	var err error
	var ans lrzxLXR.Config
	path := "/anti-spyware-profiles"
...
//
// Method: get
// URI: /anti-spyware-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (lrzxLXR.Config, error) {
	// Variables.
	var err error
	var ans lrzxLXR.Config
	path := "/anti-spyware-profiles/{id}"
...
// Method: put
// URI: /anti-spyware-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (lrzxLXR.Config, error) {
	// Variables.
	var err error
	var ans lrzxLXR.Config
	path := "/anti-spyware-profiles/{id}"
...
// Method: delete
// URI: /anti-spyware-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (lrzxLXR.Config, error) {
	// Variables.
	var err error
	var ans lrzxLXR.Config
	path := "/anti-spyware-profiles/{id}"
...
Param Data ([]lrzxLXR.Config): the Data param.
...
type ListOutput struct {
	Data   []lrzxLXR.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]lrzxLXR.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]lrzxLXR.Config)
		total := int(*ans.Total)
	...
	listing := make([]lrzxLXR.Config, 0, len(items))
	for key := range items {
