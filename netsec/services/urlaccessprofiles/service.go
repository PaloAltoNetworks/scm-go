...
//
// Method: post
// URI: /url-access-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (ivVDSwf.Config, error) {
	// Variables.
	var err error
	var ans ivVDSwf.Config
	path := "/url-access-profiles"
...
//
// Method: get
// URI: /url-access-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ivVDSwf.Config, error) {
	// Variables.
	var err error
	var ans ivVDSwf.Config
	path := "/url-access-profiles/{id}"
...
// Method: put
// URI: /url-access-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ivVDSwf.Config, error) {
	// Variables.
	var err error
	var ans ivVDSwf.Config
	path := "/url-access-profiles/{id}"
...
// Method: delete
// URI: /url-access-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ivVDSwf.Config, error) {
	// Variables.
	var err error
	var ans ivVDSwf.Config
	path := "/url-access-profiles/{id}"
...
Param Data ([]ivVDSwf.Config): the Data param.
...
type ListOutput struct {
	Data   []ivVDSwf.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]ivVDSwf.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]ivVDSwf.Config)
		total := int(*ans.Total)
	...
	listing := make([]ivVDSwf.Config, 0, len(items))
	for key := range items {
