package wildfireantivirusprofiles
...
type CreateInput struct {
	...
	Request *fVAkWHS.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /wildfire-anti-virus-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (fVAkWHS.Config, error) {
	// Variables.
	var err error
	var ans fVAkWHS.Config
	path := "/wildfire-anti-virus-profiles"
...
//
// Method: get
// URI: /wildfire-anti-virus-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (fVAkWHS.Config, error) {
	// Variables.
	var err error
	var ans fVAkWHS.Config
	path := "/wildfire-anti-virus-profiles/{id}"
...
// Method: put
// URI: /wildfire-anti-virus-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (fVAkWHS.Config, error) {
	// Variables.
	var err error
	var ans fVAkWHS.Config
	path := "/wildfire-anti-virus-profiles/{id}"
...
// Method: delete
// URI: /wildfire-anti-virus-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (fVAkWHS.Config, error) {
	// Variables.
	var err error
	var ans fVAkWHS.Config
	path := "/wildfire-anti-virus-profiles/{id}"
...
Param Data ([]fVAkWHS.Config): the Data param.
...
type ListOutput struct {
	Data   []fVAkWHS.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]fVAkWHS.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]fVAkWHS.Config)
		total := int(*ans.Total)
	...
	listing := make([]fVAkWHS.Config, 0, len(items))
	for key := range items {
