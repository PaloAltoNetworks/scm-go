...
Param Request (nnsRzDg.Config): the Request param.
...
type CreateInput struct {
	...
	Request *nnsRzDg.Config `json:"request,omitempty"`
...
// Method: post
// URI: /ipsec-tunnels
func (c *Client) Create(ctx context.Context, input CreateInput) (nnsRzDg.Config, error) {
	// Variables.
	var err error
	var ans nnsRzDg.Config
	path := "/ipsec-tunnels"
...
//
// Method: get
// URI: /ipsec-tunnels/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (nnsRzDg.Config, error) {
	// Variables.
	var err error
	var ans nnsRzDg.Config
	path := "/ipsec-tunnels/{id}"
...
// Method: put
// URI: /ipsec-tunnels/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (nnsRzDg.Config, error) {
	// Variables.
	var err error
	var ans nnsRzDg.Config
	path := "/ipsec-tunnels/{id}"
...
// Method: delete
// URI: /ipsec-tunnels/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (nnsRzDg.Config, error) {
	// Variables.
	var err error
	var ans nnsRzDg.Config
	path := "/ipsec-tunnels/{id}"
...
Param Data ([]nnsRzDg.Config): the Data param.
...
type ListOutput struct {
	Data   []nnsRzDg.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]nnsRzDg.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]nnsRzDg.Config)
		total := int(*ans.Total)
	...
	listing := make([]nnsRzDg.Config, 0, len(items))
	for key := range items {
