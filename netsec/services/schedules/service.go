...
Param Request (mCcgFKg.Config): the Request param.
...
type CreateInput struct {
	...
	Request *mCcgFKg.Config `json:"request,omitempty"`
...
// Method: post
// URI: /schedules
func (c *Client) Create(ctx context.Context, input CreateInput) (mCcgFKg.Config, error) {
	// Variables.
	var err error
	var ans mCcgFKg.Config
	path := "/schedules"
...
// Method: get
// URI: /schedules/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (mCcgFKg.Config, error) {
	// Variables.
	var err error
	var ans mCcgFKg.Config
	path := "/schedules/{id}"
...
// Method: put
// URI: /schedules/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (mCcgFKg.Config, error) {
	// Variables.
	var err error
	var ans mCcgFKg.Config
	path := "/schedules/{id}"
...
// Method: delete
// URI: /schedules/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (mCcgFKg.Config, error) {
	// Variables.
	var err error
	var ans mCcgFKg.Config
	path := "/schedules/{id}"
...
Param Data ([]mCcgFKg.Config): the Data param.
...
type ListOutput struct {
	Data   []mCcgFKg.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]mCcgFKg.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]mCcgFKg.Config)
		total := int(*ans.Total)
	...
	listing := make([]mCcgFKg.Config, 0, len(items))
	for key := range items {
