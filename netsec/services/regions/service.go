...
Param Request (mhJDwSQ.Config): the Request param.
...
type CreateInput struct {
	...
	Request *mhJDwSQ.Config `json:"request,omitempty"`
...
// Method: post
// URI: /regions
func (c *Client) Create(ctx context.Context, input CreateInput) (mhJDwSQ.Config, error) {
	// Variables.
	var err error
	var ans mhJDwSQ.Config
	path := "/regions"
...
// Method: get
// URI: /regions/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (mhJDwSQ.Config, error) {
	// Variables.
	var err error
	var ans mhJDwSQ.Config
	path := "/regions/{id}"
...
// Method: put
// URI: /regions/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (mhJDwSQ.Config, error) {
	// Variables.
	var err error
	var ans mhJDwSQ.Config
	path := "/regions/{id}"
...
// Method: delete
// URI: /regions/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (mhJDwSQ.Config, error) {
	// Variables.
	var err error
	var ans mhJDwSQ.Config
	path := "/regions/{id}"
...
Param Data ([]mhJDwSQ.Config): the Data param.
...
type ListOutput struct {
	Data   []mhJDwSQ.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]mhJDwSQ.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]mhJDwSQ.Config)
		total := int(*ans.Total)
	...
	listing := make([]mhJDwSQ.Config, 0, len(items))
	for key := range items {
