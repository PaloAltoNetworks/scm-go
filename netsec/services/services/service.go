...
Param Request (ujXZojh.Config): the Request param.
...
type CreateInput struct {
	...
	Request *ujXZojh.Config `json:"request,omitempty"`
...
// Method: post
// URI: /services
func (c *Client) Create(ctx context.Context, input CreateInput) (ujXZojh.Config, error) {
	// Variables.
	var err error
	var ans ujXZojh.Config
	path := "/services"
...
// Method: get
// URI: /services/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (ujXZojh.Config, error) {
	// Variables.
	var err error
	var ans ujXZojh.Config
	path := "/services/{id}"
...
// Method: put
// URI: /services/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (ujXZojh.Config, error) {
	// Variables.
	var err error
	var ans ujXZojh.Config
	path := "/services/{id}"
...
// Method: delete
// URI: /services/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (ujXZojh.Config, error) {
	// Variables.
	var err error
	var ans ujXZojh.Config
	path := "/services/{id}"
...
Param Data ([]ujXZojh.Config): the Data param.
...
type ListOutput struct {
	Data   []ujXZojh.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]ujXZojh.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]ujXZojh.Config)
		total := int(*ans.Total)
	...
	listing := make([]ujXZojh.Config, 0, len(items))
	for key := range items {
