package kerberosserverprofiles
...
Param Request (lNTtdgX.Config): the Request param.
...
type CreateInput struct {
	...
	Request *lNTtdgX.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /kerberos-server-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (lNTtdgX.Config, error) {
	// Variables.
	var err error
	var ans lNTtdgX.Config
	path := "/kerberos-server-profiles"
...
//
// Method: get
// URI: /kerberos-server-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (lNTtdgX.Config, error) {
	// Variables.
	var err error
	var ans lNTtdgX.Config
	path := "/kerberos-server-profiles/{id}"
...
// Method: put
// URI: /kerberos-server-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (lNTtdgX.Config, error) {
	// Variables.
	var err error
	var ans lNTtdgX.Config
	path := "/kerberos-server-profiles/{id}"
...
// Method: delete
// URI: /kerberos-server-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (lNTtdgX.Config, error) {
	// Variables.
	var err error
	var ans lNTtdgX.Config
	path := "/kerberos-server-profiles/{id}"
...
Param Data ([]lNTtdgX.Config): the Data param.
...
type ListOutput struct {
	Data   []lNTtdgX.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]lNTtdgX.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]lNTtdgX.Config)
		total := int(*ans.Total)
	...
	listing := make([]lNTtdgX.Config, 0, len(items))
	for key := range items {
