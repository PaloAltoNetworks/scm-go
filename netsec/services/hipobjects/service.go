...
// Method: post
// URI: /hip-objects
func (c *Client) Create(ctx context.Context, input CreateInput) (suxdMuj.Config, error) {
	// Variables.
	var err error
...
// Method: get
// URI: /hip-objects/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (suxdMuj.Config, error) {
	// Variables.
	var err error
	var ans suxdMuj.Config
	path := "/hip-objects/{id}"
...
// Method: put
// URI: /hip-objects/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (suxdMuj.Config, error) {
	// Variables.
	var err error
	var ans suxdMuj.Config
	path := "/hip-objects/{id}"
...
// Method: delete
// URI: /hip-objects/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (suxdMuj.Config, error) {
	// Variables.
	var err error
	var ans suxdMuj.Config
	path := "/hip-objects/{id}"
...
Param Data ([]suxdMuj.Config): the Data param.
...
type ListOutput struct {
	Data   []suxdMuj.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]suxdMuj.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]suxdMuj.Config)
		total := int(*ans.Total)
	...
	listing := make([]suxdMuj.Config, 0, len(items))
	for key := range items {
