...
Param Request (eXzfzFj.Config): the Request param.
...
type CreateInput struct {
	...
	Request *eXzfzFj.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /tls-service-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (eXzfzFj.Config, error) {
	// Variables.
	var err error
	var ans eXzfzFj.Config
	path := "/tls-service-profiles"
...
//
// Method: get
// URI: /tls-service-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (eXzfzFj.Config, error) {
	// Variables.
	var err error
	var ans eXzfzFj.Config
	path := "/tls-service-profiles/{id}"
...
// Method: put
// URI: /tls-service-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (eXzfzFj.Config, error) {
	// Variables.
	var err error
	var ans eXzfzFj.Config
	path := "/tls-service-profiles/{id}"
...
// Method: delete
// URI: /tls-service-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (eXzfzFj.Config, error) {
	// Variables.
	var err error
	var ans eXzfzFj.Config
	path := "/tls-service-profiles/{id}"
...
Param Data ([]eXzfzFj.Config): the Data param.
...
type ListOutput struct {
	Data   []eXzfzFj.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]eXzfzFj.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]eXzfzFj.Config)
		total := int(*ans.Total)
	...
	listing := make([]eXzfzFj.Config, 0, len(items))
	for key := range items {
