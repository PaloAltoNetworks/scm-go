...
Param Request (irQawLY.Config): the Request param.
...
type CreateInput struct {
	...
	Request *irQawLY.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /dns-security-profiles
func (c *Client) Create(ctx context.Context, input CreateInput) (irQawLY.Config, error) {
	// Variables.
	var err error
	var ans irQawLY.Config
	path := "/dns-security-profiles"
...
//
// Method: get
// URI: /dns-security-profiles/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (irQawLY.Config, error) {
	// Variables.
	var err error
	var ans irQawLY.Config
	path := "/dns-security-profiles/{id}"
...
// Method: put
// URI: /dns-security-profiles/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (irQawLY.Config, error) {
	// Variables.
	var err error
	var ans irQawLY.Config
	path := "/dns-security-profiles/{id}"
...
// Method: delete
// URI: /dns-security-profiles/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (irQawLY.Config, error) {
	// Variables.
	var err error
	var ans irQawLY.Config
	path := "/dns-security-profiles/{id}"
...
Param Data ([]irQawLY.Config): the Data param.
...
type ListOutput struct {
	Data   []irQawLY.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]irQawLY.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]irQawLY.Config)
		total := int(*ans.Total)
	...
	listing := make([]irQawLY.Config, 0, len(items))
	for key := range items {
