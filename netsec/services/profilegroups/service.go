...
Param Request (qhaCvMo.Config): the Request param.
...
type CreateInput struct {
	...
	Request *qhaCvMo.Config `json:"request,omitempty"`
...
// Method: post
// URI: /profile-groups
func (c *Client) Create(ctx context.Context, input CreateInput) (qhaCvMo.Config, error) {
	// Variables.
	var err error
	var ans qhaCvMo.Config
	path := "/profile-groups"
...
//
// Method: get
// URI: /profile-groups/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (qhaCvMo.Config, error) {
	// Variables.
	var err error
	var ans qhaCvMo.Config
...
// Method: put
// URI: /profile-groups/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (qhaCvMo.Config, error) {
	// Variables.
	var err error
	var ans qhaCvMo.Config
	path := "/profile-groups/{id}"
...
// Method: delete
// URI: /profile-groups/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (qhaCvMo.Config, error) {
	// Variables.
	var err error
	var ans qhaCvMo.Config
	path := "/profile-groups/{id}"
...
Param Data ([]qhaCvMo.Config): the Data param.
...
type ListOutput struct {
	Data   []qhaCvMo.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]qhaCvMo.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]qhaCvMo.Config)
		total := int(*ans.Total)
	...
	listing := make([]qhaCvMo.Config, 0, len(items))
	for key := range items {
