...
Param Request (eumQbRC.Config): the Request param.
...
type CreateInput struct {
	...
	Request *eumQbRC.Config `json:"request,omitempty"`
...
//
// Method: post
// URI: /anti-spyware-signatures
func (c *Client) Create(ctx context.Context, input CreateInput) (eumQbRC.Config, error) {
	// Variables.
	var err error
	var ans eumQbRC.Config
	path := "/anti-spyware-signatures"
...
//
// Method: get
// URI: /anti-spyware-signatures/{id}
func (c *Client) Read(ctx context.Context, input ReadInput) (eumQbRC.Config, error) {
	// Variables.
	var err error
	var ans eumQbRC.Config
	path := "/anti-spyware-signatures/{id}"
...
// Method: put
// URI: /anti-spyware-signatures/{id}
func (c *Client) Update(ctx context.Context, input UpdateInput) (eumQbRC.Config, error) {
	// Variables.
	var err error
	var ans eumQbRC.Config
	path := "/anti-spyware-signatures/{id}"
...
// Method: delete
// URI: /anti-spyware-signatures/{id}
func (c *Client) Delete(ctx context.Context, input DeleteInput) (eumQbRC.Config, error) {
	// Variables.
	var err error
	var ans eumQbRC.Config
	path := "/anti-spyware-signatures/{id}"
...
Param Data ([]eumQbRC.Config): the Data param.
...
type ListOutput struct {
	Data   []eumQbRC.Config `json:"data,omitempty"`
	Limit  *int64           `json:"limit,omitempty"`
	Offset *int64           `json:"offset,omitempty"`
...
func (c *Client) listAll(ctx context.Context, input ListInput) (ListOutput, error) {
	var err error
	var ans ListOutput
	var items map[string]eumQbRC.Config
	maxLimit := int64(2000)
	...
	for {
		...
		items = make(map[string]eumQbRC.Config)
		total := int(*ans.Total)
	...
	listing := make([]eumQbRC.Config, 0, len(items))
	for key := range items {
